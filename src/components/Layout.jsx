      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Column 1: About */}
            <div>
              <h3 className="text-xl font-bold mb-4">Álvaro Puertas</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="/calendar" className="text-gray-300 hover:text-white transition">Race Calendar</a>
                </li>
                <li>
                  <a href="/professional" className="text-gray-300 hover:text-white transition">Professional Life</a>
                </li>
                <li>
                  <a href="/next-challenges" className="text-gray-300 hover:text-white transition">Next Challenges</a>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Álvaro Puertas. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
